  ...
  (s.n = (e) => {
    ...
    (() => {
      ...
      function n(e) {
        ...
        const n = document.querySelector(".input-first-name-wrapper"),
          o = document.querySelector(".input-password-wrapper"),
          a = [
            {
              tagName: "input",
          ...
          t(s, [
            {
              ...
              textContent:
                "to delete or edit messages please use right mouse click",
            },
          ]),
